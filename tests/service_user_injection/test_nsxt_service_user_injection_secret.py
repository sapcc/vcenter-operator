...
def test_inject_user_info(state, jinja_env):
    ...
    service_user_crds = {"nsxt": (K8S_RESOURCEVERSION, SPEC, NAMESPACE)}
    ...
    assert (
        ...
        == dedent("""
            ...
            data:
              ...
              neutron-nsxv3-secrets.conf: 
           """ # noqa: E501
    ))
    ...
    assert (
        ...
        == dedent("""
            ...
            data:
              ...
              neutron-nsxv3-secrets.conf: 
        """ # noqa: E501
    ))
